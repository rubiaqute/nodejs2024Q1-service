...
import { isValidCreateAlbumPayload, isValidUpdateAlbumPayload } from 'src/utils/validation';
...
export class AlbumsController {
    ...
    @Put(':id')
    updateAlbum(@Param() params: any, @Body() updateAlbumPayload: UpdateAlbumDto) {
        const albumId = params.id
        const isValidUuid = uuidValidate(albumId)
